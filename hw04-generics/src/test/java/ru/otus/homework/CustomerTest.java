...
class CustomerTest {
    ...
    @Test
    @DisplayName("Checking that the Customer class is not broken")
    ...
    @Test
    @DisplayName("Object Customer as key in map")
    ...
    @Test
    @DisplayName("Sorting by the score field, iterating in ascending order")
